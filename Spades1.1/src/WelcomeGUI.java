...
public class WelcomeGUI extends JFrame {
	 ...
	 */
	private JLabel player1, player2, player3, player4, screenRes, logo;

	/**
	 * Declare all buttons to be used
	 */
	private JButton p1button, p2button, p3button, p4button, play, rules;
	...
	/**
	 * The ImageIcon to hold the logo image for size manipulation
	 */
	private ImageIcon logoIcon;

	/**
	 * The Images to hold the logo image for size manipulation
	 */
	private Image logoImage, scaledImage;
	...
	private void initializeVariables() {
		...
		logoIcon = new ImageIcon("src/PNG-cards-1.3/Logo.png");
		logoImage = logoIcon.getImage();
		scaledImage = logoImage.getScaledInstance(617, 274, Image.SCALE_FAST);
	...
	private void initializeScreenResolution() {
		screenRes = new JLabel("Screen Resolution:");
